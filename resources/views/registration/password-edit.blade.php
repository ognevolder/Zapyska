<x-layout>
  <main class="w-full h-full grid place-items-center">
    <form method="POST" action="{{ route('password.update') }}" class="w-full md:w-[80%] lg:w-[60%]">
      <!-- CSRF-token -->
      @csrf
      <!-- Method -->
      @method('PUT')
      ...
      <!-- Header -->
      <x-form-header>Зміна паролю</x-form-header>
      <!-- Body -->
      <div class="mx-8 flex flex-col gap-3">
        <!-- Current password input-field -->
        <x-form-input id="curent_password" name="current_password" type="password">Старий пароль</x-form-input>
