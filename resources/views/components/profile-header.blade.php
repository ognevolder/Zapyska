<header class="w-full flex justify-center border-[0.5px] border-lightgreen bg-[#fff]">
  <section class="w-full mx-4 flex justify-between items-center 2xl:w-[1440px]">
    <div>
      @auth
    ...
    <div class="flex items-center gap-1 bg-lightgreen py-1 px-2">
      ...
      <a href="/posts/create" class="text-sm text-black font-display font-semibold uppercase">Створити</a>
    </div>
  </section>
</header>
